...
Aluno: Bruno Sampaio Alves
                        ...
                        Projeto final - ETAPA 00

Este codigo foi elaborado como ponto de partida para o projeto de otimizacao.
Inicialmente o que se fez aqui foi criar um portico espacial com um determinado
carregamento e verificar os resultados do mesmo com o software SAP2000. 
Deste modo, validando-se que o sistema inicialmente esta montado corretamente.
